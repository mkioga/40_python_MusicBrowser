...
# final correction was done on CORRECTION_1; where we added exportselection=False to clear IndexError: tuple index out of range
...
class Scrollbox(tkinter.Listbox):
    ...
    def __init__(self, window, **kwargs):
        ...
        super().__init__(window, **kwargs, exportselection=False)  # CORRECTION_1; we added exportselection=False to clear IndexError: tuple index out of range
