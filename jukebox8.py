...
# We got the code to run perfectly under jukebox7
# Now we will do some cleanup and will label them CHANGE_37

# There is a bug in this code which we will fix in jukebox9.py
